---
id: openscroll-capture-api
title: "OpenScroll Capture API"
description: "API for capturing AI conversations from various providers."
...
<Heading
  ...
  children={"OpenScroll Capture API"}
>
</Heading>
...
>
  ...
  >
    ...
    OpenScroll API Support: 
  </span><span>
    URL: [https://github.com/openscroll/openscroll-server](https://github.com/openscroll/openscroll-server)
  </span>
</div><div
