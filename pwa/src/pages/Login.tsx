      ...
      <div className="min-h-[80vh] flex items-center justify-center p-4">
        <Card variant="glass" padding="lg" className="max-w-md w-full text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            Add <code className="text-xs bg-secondary px-1 rounded">VITE_SUPABASE_URL</code> and <code className="text-xs bg-secondary px-1 rounded">VITE_SUPABASE_ANON_KEY</code> to your environment variables.
          </p>
          <Button onClick={() => navigate('/')}>Continue Anonymously</Button>
        </Card>
      </div>
    );
  }
    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 max-w-4xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
        ...
        <div className="w-full max-w-md mx-auto">
          <Card variant="glass" padding="lg" className="border-none shadow-2xl space-y-6 py-8">
            ...
            <Button
              ...
              fullWidth
              size="lg"
              className="h-12 rounded-xl text-lg border-border/50"
