---
title: Atomic Chat Units (ACUs)
description: The sovereign units of VIVIM's AI memory
---

# Atomic Chat Units (ACUs)

**Atomic Chat Units (ACUs)** are the building blocks of VIVIM's sovereign context system. They are distilled fragments of knowledge extracted from your conversations, cryptographically tokenized on your personal blockchain.

---

## What Are ACUs?

ACUs represent the **smallest indivisible units of knowledge** captured during your AI interactions:
